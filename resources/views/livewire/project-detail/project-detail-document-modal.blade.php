        ...
        <div class="flex-1 p-4 sm:p-6 overflow-y-auto bg-gray-50/50 dark:bg-gray-900/50">
            <div class="space-y-4">
                @php
                    ...
                    // Custom sort function for Indonesian day names and other date formats - REVERSED to put today at bottom
                    $sortedKeys = $groupedComments->keys()->sort(function ($a, $b) {
                        // Define a custom priority for specific keys with REVERSED priority
                        // Higher numbers appear later in the list
                        $priority = [
                            'today' => 100, // Today appears last
                            'yesterday' => 99,
                            'Senin' => 98,
                            'Selasa' => 97,
                            'Rabu' => 96,
                        ...
                        // If only one is in our priority array, that one is "newer" so should be later
                        if (isset($priority[$a])) {
                            return 1; // Changed from -1 to 1 to reverse
                        }
                        if (isset($priority[$b])) {
                            return -1; // Changed from 1 to -1 to reverse
                        }
                        // For dates in the format "j F", try to compare by proximity to today
                        try {
                            ...
                            // Reverse the comparison to put older dates at top
                            return $dateA->diffInDays(now()) <=> $dateB->diffInDays(now());
                        } catch (\Exception $e) {
                            // If parsing fails, reverse the comparison of strings
                            return -1 * ($a <=> $b);
                        }
                    });
                ...
                @forelse($groupedComments as $dateGroup => $commentsInGroup)
                    ...
                    <div class="flex justify-center relative my-6">
                        ...
                        <div class="relative px-4 bg-gray-50/80 dark:bg-gray-900/80 rounded-full z-10">
                ...
                @empty
                    <div class="text-center py-12">
                        ...
                        <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-1">Belum ada komentar</h4>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Jadilah yang pertama berkomentar pada
                            dokumen ini</p>
                    </div>
                @endforelse
            </div>
                            ...
                            <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                                <div class="flex items-center justify-between">
                                    ...
                                    {{ match ($previewingDocument->status) {
                                        ...
                                        <x-dynamic-component :component="$this->getStatusIcon($previewingDocument->status)" class="w-3.5 h-3.5 mr-1" />
                                            ...
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 space-y-1">
                                                    <p
                                                        ...
                                                        Document Notes</p>
                                                    <div
                                                        class="text-gray-700 dark:text-gray-300 max-h-[16rem] overflow-y-auto">
