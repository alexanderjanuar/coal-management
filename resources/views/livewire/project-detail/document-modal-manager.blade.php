        ...
        <div class="flex flex-col lg:flex-row h-full bg-gray-50 dark:bg-gray-900">
            ...
            <div
                ...
                <div
                    ...
                    {{-- Close Button --}}
                    <button x-on:click="$dispatch('close-modal', { id: 'documentModal' })" type="button"
            ...
            <div
                ...
                <div class="sticky bottom-0 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700"
                    x-data="{ showCommentForm: false }" @showCommentForm.window="showCommentForm = true">
            ...
            <x-filament::modal id="preview-document" wire:model="isPreviewModalOpen" width="7xl">
                ...
                <div class="flex flex-col lg:flex-row h-[calc(100vh-14rem)] sm:h-[calc(100vh-10rem)]"
                    ...
                    <div class="w-full transition-all duration-300 ease-in-out h-full p-2 sm:p-4 relative"
                        ...
                        <!-- Document Navigation -->
                        @if(isset($document) && $document->submittedDocuments->count() > 1)
                        <div
                            ...
                            <div
                                ...
                                <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        <h3 class="text-sm font-medium text-gray-900 dark:text-white">Document Status
                                        </h3>
                                ...
                                <div
                                    ...
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div class="min-w-0">
                                            <p class="text-xs font-medium text-red-700 dark:text-red-400 mb-1">Rejection
                                                Reason:
                                            </p>
                                            <div
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-100 dark:ring-gray-700 overflow-hidden flex-1"
                                ...
                                <div class="p-4 flex-1 overflow-auto">
                                    ...
                                    <div x-show="!showNotesForm"
                                        ...
                                        <div class="p-4 rounded-lg {{ match($previewingDocument->status) {
                                                'uploaded' => 'bg-blue-50 border-blue-100 dark:bg-blue-900/20 dark:border-blue-800/30',
                                                'pending_review' => 'bg-amber-50 border-amber-100 dark:bg-amber-900/20 dark:border-amber-800/30',
                                                'approved' => 'bg-green-50 border-green-100 dark:bg-green-900/20 dark:border-green-800/30',
                                                'rejected' => 'bg-red-50 border-red-100 dark:bg-red-900/20 dark:border-red-800/30',
                                                default => 'bg-gray-50 border-gray-100 dark:bg-gray-800/50 dark:border-gray-700/30'
                                            } }} border">
                                            <div class="flex items-start gap-3">
                                                <div class="flex-shrink-0 mt-1">
                                                    <x-heroicon-m-document-text class="w-5 h-5 {{ match($previewingDocument->status) {
                                                            'uploaded' => 'text-blue-600 dark:text-blue-400',
                                                            'pending_review' => 'text-amber-600 dark:text-amber-400',
                                                            'approved' => 'text-green-600 dark:text-green-400',
                                                            'rejected' => 'text-red-600 dark:text-red-400',
                                                ...
                                                <div class="flex-1 space-y-1">
                                                    <p class="text-sm font-medium {{ match($previewingDocument->status) {
                                                            'uploaded' => 'text-blue-700 dark:text-blue-400',
                                                            'pending_review' => 'text-amber-700 dark:text-amber-400',
                                                            'approved' => 'text-green-700 dark:text-green-400',
                                                            'rejected' => 'text-red-700 dark:text-red-400',
            ...
            <x-filament::modal id="confirm-delete-modal" width="md">
                ...
                <x-slot name="footer">
                    <div class="flex justify-end gap-3">
                        ...
                        <x-filament::button
                            wire:click="removeDocument({{ $previewingDocument ? $previewingDocument->id : 'null' }})"
                        ...
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    ...
                                    @php
                                    $fileType = strtolower(pathinfo($documentBeingRejected->file_path,
                                    PATHINFO_EXTENSION));
                                    @endphp
                                    @if($fileType === 'pdf')
                                    <x-heroicon-o-document-text class="w-5 h-5 text-gray-500 dark:text-gray-400" />
