    ...
    <div class="space-y-4 md:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('filament.admin.pages.client-communication.create') }}"
                class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors w-full sm:w-auto">
        ...
        {{-- Filters and Tabs Section - Responsive --}}
        <div
            class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 pb-4 border-b border-gray-200 dark:border-gray-700">
            {{-- Date Range Filter --}}
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                ...
                <button wire:click="clearDateRange"
                    class="px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700 w-full sm:w-auto">
                    Clear Filter
                </button>
                @endif
            </div>

            {{-- Status Tabs - Scrollable on mobile, normal on desktop --}}
            <div class="w-full lg:w-auto overflow-x-auto">
                <div class="relative inline-flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg p-1 min-w-max">
                    ...
                    <button wire:click="setActiveTab('all')"
                        class="relative z-10 px-3 sm:px-4 py-1.5 text-xs font-medium rounded-md transition-colors duration-200 {{ $activeTab === 'all' ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        All
                    </button>
                    <button wire:click="setActiveTab('scheduled')"
                        class="relative z-10 px-3 sm:px-4 py-1.5 text-xs font-medium rounded-md transition-colors duration-200 {{ $activeTab === 'scheduled' ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Scheduled
                    </button>
                    <button wire:click="setActiveTab('completed')"
                        class="relative z-10 px-3 sm:px-4 py-1.5 text-xs font-medium rounded-md transition-colors duration-200 {{ $activeTab === 'completed' ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Completed
                    </button>
                    <button wire:click="setActiveTab('cancelled')"
                        class="relative z-10 px-3 sm:px-4 py-1.5 text-xs font-medium rounded-md transition-colors duration-200 {{ $activeTab === 'cancelled' ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Cancelled
                    </button>
                    <button wire:click="setActiveTab('rescheduled')"
                        class="relative z-10 px-3 sm:px-4 py-1.5 text-xs font-medium rounded-md transition-colors duration-200 {{ $activeTab === 'rescheduled' ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Rescheduled
                    </button>
                </div>
            </div>
        ...
        <div class="space-y-4 md:space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3 md:space-y-4">
                    ...
                    <div
                        class="{{ $cardClasses }} {{ $hoverClasses }} {{ $textOpacity }} rounded-xl border hover:shadow-lg transition-all duration-200 hidden lg:block">
                        <div class="p-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-shrink-0 text-center w-12">
                                    <div class="text-xs font-medium {{ 
                                        ...
                                        @php
                                        $dayMap = ['Mon' => 'Sen', 'Tue' => 'Sel', 'Wed' => 'Rab', 'Thu' => 'Kam', 'Fri'
                                        => 'Jum', 'Sat' => 'Sab', 'Sun' => 'Min'];
                                ...
                                <div class="flex-shrink-0 flex flex-col justify-center" style="width: 160px;">
                                    <div class="flex items-center gap-2 text-sm text-gray-900 dark:text-white mb-1.5">
                                        ...
                                        <span>
                                            ...
                                            : '00:00' }}
                                            -
                                            {{ $communication->communication_time_end ?
                                ...
                                <div class="flex-1 min-w-0 flex flex-col justify-center">
                                    <div class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Description
                                    </div>
                                ...
                                <div class="flex -space-x-2 flex-shrink-0 items-center">
                                    ...
                                    <div
                                        ...
                                        <span class="text-xs font-medium text-white">{{
                                            strtoupper(substr($participant->name, 0, 2)) }}</span>
                                        @endif
                                    </div>
                                    @endforeach
                                    @if($remaining > 0)
                    ...
                    <div
                        class="{{ $cardClasses }} {{ $hoverClasses }} {{ $textOpacity }} rounded-xl border hover:shadow-lg transition-all duration-200 lg:hidden">
                        <div class="p-3 sm:p-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="flex-shrink-0 text-center">
                                        <div class="text-xs font-medium {{ 
                                            ...
                                            @php
                                            $dayMap = ['Mon' => 'Sen', 'Tue' => 'Sel', 'Wed' => 'Rab', 'Thu' => 'Kam',
                            ...
                            @php
                            $participants = $communication->internalParticipantUsers ?? collect([]);
                            $remaining = max(0, $participants->count() - 3);
                            @endphp
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <div class="flex -space-x-2">
                                    ...
                                    <div
                                        class="relative inline-flex items-center justify-center w-7 h-7 overflow-hidden bg-gradient-to-br from-purple-500 to-pink-500 rounded-full border-2 border-white dark:border-gray-800">
                                        @if($participant->avatar_url)
                                        <img src="{{ $participant->avatar_url }}" alt="{{ $participant->name }}"
                                            class="w-full h-full object-cover">
                                        @else
                                    ...
                                    @if($remaining > 0)
                                    <div
                                        class="relative inline-flex items-center justify-center w-7 h-7 bg-gray-200 dark:bg-gray-700 rounded-full border-2 border-white dark:border-gray-800">
                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-300">+{{
                                            $remaining }}</span>
                                    </div>
                                    @endif
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                <button wire:click="openViewModal({{ $communication->id }})"
                                    class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                @if(in_array($communication->status, ['scheduled', 'rescheduled']))
                                <button wire:click="openCompleteModal({{ $communication->id }})"
                                    class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-green-700 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 dark:bg-green-900/20 dark:text-green-400 dark:border-green-800">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7" />
                                    </svg>
                                ...
                                <a href="{{ route('filament.admin.pages.client-communication.{record}.edit', ['record' => $communication->id]) }}"
                                    class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-gray-700 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
    ...
    <x-filament::modal id="complete-communication-modal" width="xl sm:2xl md:3xl lg:4xl">
        <x-slot name="heading">
            <div class="flex items-center gap-2">
                ...
                <span class="text-base sm:text-lg">Tandai Komunikasi Selesai</span>
            </div>
        </x-slot>
        ...
        <form wire:submit="markAsCompleted">
            ...
            <div class="mt-6 flex flex-col sm:flex-row justify-end gap-3">
                <x-filament::button color="gray" wire:click="closeCompleteModal" type="button" class="w-full sm:w-auto">
                    Batal
                </x-filament::button>

                <x-filament::button type="submit" color="success" class="w-full sm:w-auto">
    ...
    <x-filament::modal id="view-communication-modal" width="xl sm:2xl md:3xl lg:4xl xl:5xl">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">{{
                            $viewCommunication->title ?? 'Detail Komunikasi' }}</h3>
                        <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Informasi lengkap komunikasi
                            dengan klien</p>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-3 sm:space-y-4">
            ...
            <div
                ...
                <div class="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 dark:bg-gray-900/50">
                    <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">Informasi Umum</h4>
                </div>
                <div class="px-3 sm:px-4 py-2 sm:py-3 space-y-2 sm:space-y-3">
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Status:</span>
                        <span class="inline-flex items-center gap-1.5 px-2 sm:px-2.5 py-0.5 text-xs font-medium rounded-md w-fit {{ 
                    ...
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Klien:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                            $viewCommunication->client->name ?? '-' }}</span>
                    </div>
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Penanggung Jawab:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                            $viewCommunication->user->name ?? '-' }}</span>
                    </div>
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Jenis Komunikasi:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                            $viewCommunication->type_label }}</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between py-2 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Proyek Terkait:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 dark:bg-gray-900/50">
                    <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">Jadwal & Lokasi</h4>
                </div>
                <div class="px-3 sm:px-4 py-2 sm:py-3 space-y-2 sm:space-y-3">
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Tanggal:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                            $viewCommunication->communication_date->format('d F Y') }}</span>
                    </div>
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Waktu Mulai:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                    ...
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 border-b border-gray-100 dark:border-gray-700 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Waktu Selesai:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                    ...
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 {{ $viewCommunication->meeting_platform ? 'border-b border-gray-100 dark:border-gray-700' : '' }} gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Lokasi:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                            $viewCommunication->location ?? '-' }}</span>
                    </div>
                    @if($viewCommunication->meeting_platform)
                    <div
                        class="flex flex-col sm:flex-row sm:justify-between py-2 {{ $viewCommunication->meeting_link ? 'border-b border-gray-100 dark:border-gray-700' : '' }} gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Platform:</span>
                        <span class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between py-2 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Link Meeting:</span>
                        <a href="{{ $viewCommunication->meeting_link }}" target="_blank"
                            class="text-xs sm:text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 flex items-center gap-1 break-all">
                            <span>Buka Link</span>
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 dark:bg-gray-900/50">
                    <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">Detail & Catatan</h4>
                </div>
                <div class="px-3 sm:px-4 py-2 sm:py-3 space-y-3 sm:space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs sm:text-sm text-gray-900 dark:text-white">{{
                            $viewCommunication->description }}</p>
                    </div>
                    @endif
                    ...
                    <div>
                        ...
                        <div class="mt-1 prose prose-sm dark:prose-invert max-w-none text-xs sm:text-sm">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs sm:text-sm text-gray-900 dark:text-white">{{ $viewCommunication->notes }}
                        </p>
                    </div>
                    @endif
                </div>
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 dark:bg-gray-900/50">
                    <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">Lampiran ({{
                        count($viewCommunication->attachments) }})</h4>
                </div>
                <div class="px-3 sm:px-4 py-2 sm:py-3 space-y-2">
                    ...
                    <a href="{{ Storage::url($attachment) }}" target="_blank"
                        ...
                        <span
                            class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 break-all">{{
