<x-filament-panels::page>
    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div
                class="p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl shadow-sm border border-indigo-100">
            ...
            <div class="p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-sm border border-green-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($stats['total_tax'], 0, ',',
                            '.') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-200 lg:col-span-2 overflow-hidden">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="{{ route('filament.admin.resources.tax-reports.index') }}"
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-gray-900">{{ $report->client->name ??
                                                'Client' }}</p>
                                            <p class="text-xs text-gray-500">{{ $report->month }} · {{
                                ...
                                <a href="{{ route('filament.admin.resources.tax-reports.view', $report) }}"
                                    ...
                                    Detail
                                    <svg class="ml-1.5 -mr-1 h-4 w-4 text-gray-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 5l7 7-7 7" />
                                    </svg>
                        ...
                        <li class="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-150">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="h-12 w-12 flex items-center justify-center rounded-lg bg-indigo-100 text-indigo-600 font-bold text-lg">
                                ...
                                <div class="ml-4 flex-1">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center">
                                            <svg class="h-4 w-4 text-indigo-500 mr-1" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                                    d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z"
                                                    clip-rule="evenodd" />
                                            </svg>
                                            <span class="text-sm font-medium text-gray-600">{{ $client->taxreports_count
                                                }}</span>
                                        </div>
                                    </div>
                                    <div class="mt-2 flex justify-between items-center">
                                        ...
                                        <p class="text-sm font-medium text-green-600">Rp {{
                                            number_format($client->invoices_sum_ppn ?? 0, 0, ',', '.') }}</p>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="mt-1 text-sm text-gray-600">
                                    Pastikan semua faktur pajak memiliki bukti pendukung yang valid untuk menghindari
                    ...
                    <div class="p-4 bg-green-50 rounded-lg border border-green-100">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="mt-1 text-sm text-gray-600">
                                    Perhitungan PPh 21 sebaiknya dilakukan secara teliti dengan mempertimbangkan PTKP
                                    terbaru.
                                </p>
                            </div>
                        </div>
