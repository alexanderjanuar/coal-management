        ...
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex space-x-8">
                ...
                <a href="?status={{ str_replace(' ', '_', $status) }}"
                    ...
                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' => $currentStatus !==
        ...
        <div x-data="{ open: false }" class="bg-white rounded-lg shadow">
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-500">{{ $document->description }}
                                                        </p>
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    @if($submittedDoc)
                                                    <x-filament::badge size="sm" :color="match($submittedDoc->status) {
                                                                                    'approved' => 'success',
                                                                                    'rejected' => 'danger',
                                                                                    default => 'warning'
                                                                                }">
            ...
            <x-filament::card>
                <div class="text-center py-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">No projects with status "{{ ucwords(str_replace('_', ' ',
                        $currentStatus)) }}" were found.</p>
                </div>
            </x-filament::card>
            @endif
        </div>
