<div>
    <x-filament::modal id="documentModal" slide-over width='4xl'>
                ...
                <div class="flex-1 p-3 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
                        <div class="p-4">
                            ...
                            @php
                            $groupedDocuments =
                            $document->submittedDocuments->sortByDesc('created_at')->groupBy('status');
                                    ...
                                    <div class="mt-3 space-y-2.5">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <x-filament::modal id="delete-document-{{ $submission->id }}"
            ...
            <x-filament::modal id="preview-document" wire:model="isPreviewModalOpen" width="7xl">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-full">
                    ...
                    <div class="flex flex-wrap items-center gap-2 mt-2 sm:mt-0">
                        @if($previewingDocument && !auth()->user()->hasRole(['staff', 'client']))
                        <!-- Status Dropdown -->
                        <x-filament::dropdown placement="bottom-end">
                            <x-slot name="trigger">
                                <x-filament::button size="sm" :color="match($previewingDocument->status) {
                                    ...
                                    <div class="flex items-center gap-2">
                                        <x-dynamic-component
                                            :component="$this->getStatusIcon($previewingDocument->status)"
                                            class="w-4 h-4" />
                        ...
                        <div x-data="{ showSidebar: false }" class="hidden lg:block relative">
                            <button @click="showSidebar = !showSidebar; $dispatch('toggle-sidebar')" type="button"
                ...
                <div class="sm:hidden flex items-center justify-between mt-4 mb-2">
                    <x-filament::button wire:click="downloadDocument({{ $previewingDocument->id }})" color="gray"
                        size="sm" class="flex-1 justify-center mr-2">
                ...
                <div class="flex flex-col h-[calc(100vh-14rem)] sm:h-[calc(100vh-10rem)]" x-data="{ 
                    ...
                    }" @toggle-sidebar.window="if (!isMobile) showSidebar = !showSidebar" @resize.window="
                        isMobile = window.innerWidth < 1024;
                                ...
                                <div
                                    ...
                                    <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                                        <div class="flex items-center justify-between">
                                            <h3 class="text-sm font-medium text-gray-900 dark:text-white">Document
                                                Status
                                            </h3>
                                        ...
                                        <div class="flex items-center gap-3 text-sm">
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    Uploaded {{ $previewingDocument->created_at->format('M d, Y • g:i
                                                    A') }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    @if($previewingDocument->status === 'rejected' &&
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-100 dark:ring-gray-700 overflow-y-auto flex-1"
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="text-xs text-gray-500 dark:text-gray-400">Private to
                                                    staff</span>
                                    ...
                                    <div class="p-4 flex-1 overflow-auto">
                                        ...
                                        <div x-show="!showNotesForm"
                                            ...
                                            <div
                                                ...
                                                <p class="text-sm text-gray-500 dark:text-gray-400">No notes added yet
                                                </p>
        ...
        <x-filament::modal id="confirm-approve-all" alignment="center" width="sm">
            ...
            <div class="space-y-3">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    This action will approve all documents regardless of their current status. Are you sure you want to
                    continue?
                </p>
                <div
