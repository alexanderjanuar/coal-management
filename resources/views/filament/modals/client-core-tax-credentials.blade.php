            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center space-x-2">
                    <div class="flex-1 relative">
                        <input 
                            type="text" 
                            value="{{ $record->core_tax_user_id ?: 'Not configured' }}" 
                            readonly 
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-yellow-600 dark:text-yellow-400 mt-1">
                                Missing: {{ !$record->core_tax_user_id ? 'User ID' : 'Password' }}. Please complete the setup to enable Core Tax access.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
        <div class="flex items-start space-x-2">
            ...
            <div class="text-xs text-amber-700 dark:text-amber-300">
                ...
                <p class="mt-1">Keep these credentials secure and do not share them unnecessarily. Only authorized personnel should have access to Core Tax credentials.</p>
                <p class="mt-1 text-amber-600 dark:text-amber-400">Last updated: {{ $record->updated_at->format('M d, Y \a\t H:i') }}</p>
            </div>
        </div>
    </div>
</div>