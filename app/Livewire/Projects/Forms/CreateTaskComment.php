...
class CreateTaskComment extends Component implements HasForms
{
    ...
    public function createComment(): void
    {
        ...
        $this->sendNotifications($comment, 'Komentar berhasil ditambahkan');
    ...
    public function replyToComment(int $parentId): void
    {
        ...
        $this->sendNotifications($reply, 'Balasan berhasil ditambahkan');
    ...
    protected function sendNotifications(Comment $comment, string $successMessage): void
    {
        ...
        $notificationType = $comment->parent_id ? 'Balasan' : 'Komentar Baru';

        Notification::make()
            ->title($notificationType . ' di Tugas: ' . $this->task->title)
    ...
    {
        return view('livewire.projects.forms.create-task-comment',[
