                ...
                <div class="flex-1 p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto">
                    ...
                    <div
                        ...
                        <div class="px-4 sm:px-6 py-4">
                            ...
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">All uploaded documents</p>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-5">
                                @php
                                $groupedDocuments = $document->submittedDocuments->sortByDesc('created_at')->groupBy('status');
            ...
            <x-filament::modal id="preview-document" wire:model="isPreviewModalOpen" width="7xl">
                ...
                <div class="flex flex-col lg:flex-row h-[calc(100vh-14rem)] sm:h-[calc(100vh-10rem)]"
                    ...
                    <div class="w-full transition-all duration-300 ease-in-out h-full p-2 sm:p-4 relative"
                        ...
                        @if($document->submittedDocuments->count() > 1)
                        <div
                                            ...
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 space-y-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <x-heroicon-m-clock class="w-4 h-4" />
                                                        <span>Last updated {{ $previewingDocument->updated_at->diffForHumans() }}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <x-filament::modal id="confirm-delete-modal" width="md">
                ...
                <x-slot name="footer">
                    <div class="flex justify-end gap-3">
                        ...
                        <x-filament::button wire:click="removeDocument({{ $previewingDocument ? $previewingDocument->id : '' }})"
                            color="danger" size="sm">
                            <div class="flex items-center gap-1">
                                <x-heroicon-m-trash class="w-4 h-4" />
                                <span>Delete Document</span>
