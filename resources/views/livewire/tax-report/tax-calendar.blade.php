        ...
        <div class="p-4 md:p-6">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button class="px-4 py-2 border border-blue-600 text-blue-600 rounded hover:bg-blue-50 transition">
                ...
                <div class="grid grid-cols-7 gap-1">
                    @foreach($calendarDays as $day)
                        ...
                        >
                            <span>{{ $day['day'] }}</span>
                            @if($day['hasEvent'])
                                <span class="absolute bottom-2 left-1/2 transform -translate-x-1/2 h-1 w-10 bg-yellow-500 rounded-full"></span>
                            @endif
                        </div>
                    @endforeach
                </div>
                    ...
                    <div class="space-y-4">
                        @foreach($currentMonthEvents as $event)
                            <div class="flex gap-4">
                                <div class="flex items-center justify-center w-16 h-16 bg-yellow-500 text-white text-2xl font-bold rounded-md">
