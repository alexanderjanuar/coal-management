        ...
        @if ($document)
            <div class="flex flex-col lg:flex-row h-full bg-gray-50 dark:bg-gray-900">
                ...
                <div
                    ...
                    <div
                        class="sticky top-0 z-10 p-3 sm:p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                            <!-- Document Icon & Info - Stack on mobile -->
                                ...
                                <div class="min-w-0 space-y-1">
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('filament.admin.resources.clients.view', $document->projectStep->project->client->id) }}"
                                            class="font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 hover:underline transition-colors whitespace-nowrap">
                                    ...
                                    <!-- Document Name & Step - Better Mobile Layout -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <h2
                                            class="text-base sm:text-xl font-semibold text-gray-900 dark:text-white leading-tight hover:text-primary-600 dark:hover:text-primary-400 hover:underline transition-colors">
                                            {{ $document->name }}
                                        </h2>
                                        <span
                    ...
                    <div class="flex-1 p-3 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto">
                        <!-- Enhanced Status Section -->
                        <div
                            class="bg-white dark:bg-gray-900 rounded-xl shadow-sm ring-1 ring-gray-100 dark:ring-gray-700">
                            <div class="p-4">
                                <!-- Status Header -->
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                                    ...
                                    <div class="flex-shrink-0">
                                        ...
                                        {{ match ($document->status) {
                                            ...
                                            <x-dynamic-component :component="$this->getStatusIcon($document->status)" class="w-4 h-4 mr-2" />
                                    ...
                                    @if (!auth()->user()->hasRole(['staff', 'client']))
                                        <x-filament::button x-data="{}"
                                            ...
                                            color="success" size="sm" :disabled="$document->submittedDocuments->count() ===
                                ...
                                <div class="px-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-white">Reviewer</span>
                                            <span
                                                class="text-sm text-gray-500 dark:text-gray-400">{{ $document->reviewer->name }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-100 dark:ring-gray-700">
                            <div class="p-4">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Upload New Document
                                    </h4>
                                </div>
                        ...
                        <!-- Document History - Enhanced Mobile Layout -->
                        @if ($document->submittedDocuments->count() > 0)
                            <div
                                class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
                                <div class="p-4">
                                    <!-- History Header -->
                                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 class="text-sm font-medium text-gray-900 dark:text-white">Document
                                                    History
                                                </h4>
                                        ...
                                        <button wire:click="downloadAllDocuments"
                                            class="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-3 py-1.5 rounded-lg text-gray-700 dark:text-gray-200 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 shadow-sm transition-all duration-200">
                                    ...
                                    <!-- Document List - Improved Mobile Layout -->
                                    @php
                                        $groupedDocuments = $document->submittedDocuments
                                    ...
                                    <!-- Status Groups Container - Add gap between groups -->
                                    <div class="space-y-8">
                                        <!-- Changed from space-y-5 to space-y-8 for more spacing -->
                                                ...
                                                <div class="relative">
                                                    <div class="flex items-center gap-2 mb-3">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs font-medium {{ $statusColors[$status]['text'] }}">{{ $this->getStatusLabel($status) }}</span>
                                                            <span
                                                        ...
                                                        @foreach ($groupedDocuments[$status] as $submission)
                                                            <div
                                                                ...
                                                                <div class="flex items-center gap-2">
                                                                    <!-- Download Button -->
                                                                    <button
                                                                        wire:click="downloadDocument({{ $submission->id }})"
                                                                    ...
                                                                    @if (!auth()->user()->hasRole(['client']))
                                                                        <button
                                                                            ...
                                                                            class="inline-flex items-center justify-center p-1.5 rounded-lg text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/30 focus:outline-none focus:ring-2 focus:ring-red-500/30 dark:focus:ring-red-400/30 transition-all opacity-0 group-hover:opacity-100">
                                                                            <x-heroicon-m-trash class="w-4 h-4" />
                                                                        </button>

                                                                        <!-- Delete Confirmation Modal -->
                                                                        <x-filament::modal
                                                                            id="delete-document-{{ $submission->id }}"
                                                                            alignment="center" width="sm">
                                                                            <x-slot name="header">
                                                                                <div class="flex items-center gap-3">
                                                                                    <div
                                                                            ...
                                                                            <x-slot name="footer">
                                                                                <div class="flex justify-end gap-2">
                                                                                    ...
                                                                                    <x-filament::button
                                                                                        wire:click="removeDocument({{ $submission->id }})"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-2">
                                <h3 class="text-base sm:text-xl font-semibold text-gray-900 dark:text-white">Comments
                                </h3>
                                <span
                    ...
                    <!-- Comments List -->
                    <!-- Comments List with Date Separators -->
                    <!-- Comments List with Date Separators (Oldest on Top, Today at Bottom) -->
                    <div class="flex-1 p-4 sm:p-6 overflow-y-auto bg-gray-50/50 dark:bg-gray-900/50">
                        <div class="space-y-4">
                            @php
                                ...
                                $groupedComments = $comments->groupBy(function ($comment) {
                                    ...
                                    if ($date->isToday()) {
                                        ...
                                        return 'yesterday';
                                    } elseif ($date->diffInDays(now()->startOfDay()) <= 7) {
                                        // For days within the last week, use the Indonesian day name
                                        $dayNames = [
                                            0 => 'Minggu',
                                            1 => 'Senin',
                                            2 => 'Selasa',
                                ...
                                // Custom sort function for Indonesian day names and other date formats
                                // REVERSE the order so oldest is on top and newest (today) is at bottom
                                $sortedKeys = $groupedComments->keys()->sort(function ($a, $b) {
                                    // Define a custom priority for specific keys (REVERSED)
                                    $priority = [
                                        'today' => 100, // Highest number = appears last
                                        'yesterday' => 99,
                                        'Senin' => 98,
                                        'Selasa' => 97,
                                        'Rabu' => 96,
                                    ...
                                    // If only one is in our priority array, that one is "newer"
                                    if (isset($priority[$a])) {
                                        return 1; // Changed from -1 to 1 to reverse order
                                    }
                                    if (isset($priority[$b])) {
                                        return -1; // Changed from 1 to -1 to reverse order
                                    }

                                    // For dates in the format "j F", compare by proximity to today (REVERSED)
                                    try {
                                        $dateA = \Carbon\Carbon::createFromFormat('j F', $a);
                                        $dateB = \Carbon\Carbon::createFromFormat('j F', $b);

                                        // Adjust year if needed
                                        if ($dateA->month > now()->month) {
                                            $dateA->subYear();
                                        }
                                        if ($dateB->month > now()->month) {
                                            $dateB->subYear();
                                        }

                                        // Reversed comparison to put older dates first
                                        return $dateA->diffInDays(now()) <=> $dateB->diffInDays(now());
                                    } catch (\Exception $e) {
                                        // If parsing fails, just compare strings (but reversed)
                                        return -1 * ($a <=> $b);
                                    }
                                });
                            ...
                            @forelse($groupedComments as $dateGroup => $commentsInGroup)
                                <!-- Date Separator -->
                                <div class="flex justify-center relative my-4">
                                    <div class="absolute inset-0 flex items-center">
                                        <div class="w-full border-t border-gray-200 dark:border-gray-700"></div>
                                    </div>
                                    <div
                                        class="relative px-4 py-1 bg-gray-100 dark:bg-gray-800 rounded-full z-10 shadow-sm border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="space-y-6">
                                    @foreach ($commentsInGroup as $comment)
                                        <div class="flex gap-4 group">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div @class([
                                                    'bg-white dark:bg-gray-800 rounded-lg px-4 py-3 shadow-sm ring-1 transition-all',
                            ...
                            @empty
                                <div class="text-center py-12">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Jadilah yang pertama
                                        berkomentar pada dokumen ini</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <div class="sticky bottom-0 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700"
                        ...
                        <div x-show="showCommentForm" x-transition:enter="transition ease-out duration-200"
                            ...
                            <form wire:submit="addComment">
                                ...
                                <div
                                    class="bg-white dark:bg-gray-800 rounded-lg ring-1 ring-gray-200 dark:ring-gray-700">
                                    <div class="relative">
                ...
                <x-filament::modal id="preview-document" wire:model="isPreviewModalOpen" width="7xl">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-full">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-2 sm:mt-0">
                                ...
                                <x-filament::dropdown placement="bottom-end">
                                    <x-slot name="trigger">
                                        <x-filament::button size="sm" :color="match ($previewingDocument->status) {
                                            ...
                                            <div class="flex items-center gap-2">
                                                <x-dynamic-component :component="$this->getStatusIcon($previewingDocument->status)" class="w-4 h-4" />
                                                <span
                                                    class="hidden sm:inline">{{ $this->getStatusLabel($previewingDocument->status) }}</span>
                                    ...
                                    <x-filament::dropdown.list>
                                        <x-filament::dropdown.list.item
                                            ...
                                            icon="heroicon-m-clock" :color="$previewingDocument->status === 'pending_review' ? 'warning' : 'gray'">
                                            Pending Review
                                        </x-filament::dropdown.list.item>

                                        <x-filament::dropdown.list.item
                                            wire:click="updateDocumentStatus({{ $previewingDocument->id }}, 'approved')"
                                            icon="heroicon-m-check-circle" :color="$previewingDocument->status === 'approved' ? 'success' : 'gray'">
                                            Approved
                                        </x-filament::dropdown.list.item>
                            ...
                            @if ($previewingDocument)
                                ...
                                <div x-data="{ showSidebar: false }" class="hidden lg:block relative">
                                    <button @click="showSidebar = !showSidebar; $dispatch('toggle-sidebar')"
                                        type="button"
                                        class="group relative inline-flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200
                    ...
                    @if ($previewingDocument)
                        <div class="sm:hidden flex items-center justify-between mt-4 mb-2">
                            <x-filament::button wire:click="downloadDocument({{ $previewingDocument->id }})"
                                color="gray" size="sm" class="flex-1 justify-center mr-2">
                    ...
                    <div class="flex flex-col h-[calc(100vh-14rem)] sm:h-[calc(100vh-10rem)]" x-data="{
                        showSidebar: window.innerWidth >= 1024 ? false : true,
                        isMobile: window.innerWidth < 1024
                    }"
                        @toggle-sidebar.window="if (!isMobile) showSidebar = !showSidebar"
                        @resize.window="
                        isMobile = window.innerWidth < 1024;
                        if (isMobile) showSidebar = true;
                    ">

                        <!-- Mobile Document Info First -->
                        <div class="block lg:hidden mb-4" x-show="isMobile">
                        ...
                        <div class="flex flex-col lg:flex-row flex-1 gap-4">
                            ...
                            <div class="w-full lg:flex-1 transition-all duration-300 ease-in-out h-full relative">
                                ...
                                @if ($this->document->submittedDocuments->count() > 1)
                                    <div
                                        ...
                                        <button wire:click="previousDocument"
                                            class="p-2 rounded-full bg-white/80 dark:bg-gray-800/80 shadow-lg hover:bg-white dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-all group pointer-events-auto
                                    ...
                                    @if ($previewUrl)
                                            ...
                                            <div class="w-full h-full bg-gray-50 dark:bg-gray-900">
                                                <iframe src="{{ $previewUrl }}" class="w-full h-full rounded-lg">
                                                    <div class="flex flex-col items-center justify-center p-8">
                                                        ...
                                                        <h3
                                                            class="text-lg font-medium text-gray-900 dark:text-white mb-2 text-center">
                                        ...
                                        @else
                                            <div class="flex flex-col items-center justify-center h-full py-16">
                                                ...
                                                @if ($previewingDocument)
                                                    <x-filament::button
                                                        wire:click="downloadDocument({{ $previewingDocument->id }})"
                            ...
                            <!-- Right Sidebar (Always visible on mobile, toggleable on desktop) -->
                            <div x-show="showSidebar" x-transition:enter="lg:transition lg:ease-out lg:duration-300"
                                x-transition:enter-start="lg:opacity-0 lg:transform lg:translate-x-8"
                                x-transition:enter-end="lg:opacity-100 lg:transform lg:translate-x-0"
                                x-transition:leave="lg:transition lg:ease-in lg:duration-200"
                                x-transition:leave-start="lg:opacity-100 lg:transform lg:translate-x-0"
                                x-transition:leave-end="lg:opacity-0 lg:transform lg:translate-x-8"
                                class="w-full lg:w-[400px] p-2 flex-shrink-0 bg-gray-50/50 dark:bg-gray-900/50 rounded-lg overflow-y-auto">
                                @if ($previewingDocument)
                                    <div class="space-y-4 flex flex-col h-full">
                                        ...
                                        <div class="hidden sm:grid grid-cols-2 gap-3">
                                            ...
                                            <x-filament::button
                                                wire:click="downloadDocument({{ $previewingDocument->id }})"
                                                color="gray" size="md" class="justify-center">
                                                <div class="inline-flex items-center gap-2">
                                                    <x-heroicon-m-arrow-down-tray class="w-4 h-4" />
                                                    <span>Download</span>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-3 text-sm">
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <p class="text-xs text-gray-500 dark:text-gray-400">
                                                            Uploaded
                                                            {{ $previewingDocument->created_at->format('M d, Y • g:i
                                                                                                                                                                            A') }}
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-gray-100 dark:ring-gray-700 overflow-y-auto flex-1"
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        <span class="text-xs text-gray-500 dark:text-gray-400">Private
                                                            to
                                                            staff</span>
                                                        <button @click="showNotesForm = !showNotesForm" type="button"
                                                            ...
                                                            <x-heroicon-o-pencil-square x-show="!showNotesForm"
                                                                class="w-5 h-5" />
                                                            <x-heroicon-o-x-mark x-show="showNotesForm"
                                                                class="w-5 h-5" />
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <div x-show="!showNotesForm"
                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            <p class="text-sm text-gray-500 dark:text-gray-400">No
                                                                notes added yet
                                                            </p>
                                                        ...
                                                        <div class="space-y-4">
                                                            ...
                                                            <div class="flex items-center justify-end gap-2">
                                                                <x-filament::button type="button" color="gray"
                                                                    size="sm" @click="showNotesForm = false">
                                                                    Cancel
                                                                </x-filament::button>
                                                                <x-filament::button type="submit" size="sm"
                                                                    color="primary">
            ...
            <x-filament::modal id="confirm-approve-all" alignment="center" width="sm">
                ...
                <div class="space-y-3">
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        This action will approve all documents regardless of their current status. Are you sure you want
                        to
                        continue?
                    </p>
                    <div
                ...
                <x-slot name="footer">
                    <div class="flex justify-end gap-2">
                        <x-filament::button x-on:click="$dispatch('close-modal', { id: 'confirm-approve-all' })"
                            color="gray" size="sm">
                            Cancel
                        </x-filament::button>
