...
<div class="space-y-4 lg:space-y-6" x-data="taskManager()">
    ...
    <livewire:daily-task.form.daily-task-filter-component :initial-filters="$this->currentFilters" :total-tasks="$totalTasks" />
    ...
    <div class="space-y-4 lg:space-y-6">
                    ...
                    <div class="min-w-[1200px]"> {{-- Minimum width to trigger horizontal scroll --}}
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <div wire:loading.delay class="w-full">
                                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                                    @for($i = 0; $i < 5; $i++) <div class="px-6 py-4 animate-pulse w-screen">
                                        <div
                                            class="grid grid-cols-12 gap-2 xl:gap-4 items-center min-h-[48px] w-screen">
                                            {{-- Checkbox skeleton --}}
                                            ...
                                            <div class="col-span-2">
                                                <div
                                                    class="h-8 bg-gray-200 dark:bg-gray-700 rounded-lg w-full">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-span-2">
                                                <div class="flex items-center gap-2">
                                                    <div class="flex -space-x-1.5">
                                                        <div
                                                            class="w-5 h-5 bg-gray-200 dark:bg-gray-700 rounded-full border border-white dark:border-gray-800">
                                                        </div>
                                                        <div
                                                            class="w-5 h-5 bg-gray-200 dark:bg-gray-700 rounded-full border border-white dark:border-gray-800">
                                                        </div>
                                                    ...
                                                    <div
                                                        class="hidden xl:block h-3 bg-gray-200 dark:bg-gray-700 rounded flex-1 max-w-[80px]">
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="space-y-6">
            ...
            <div class=" transition-all duration-300" x-data="{ collapsed: false }">
                ...
                {{-- SKELETON untuk Grouped View --}}
                <div x-show="!collapsed" wire:loading.delay class="overflow-hidden">
                    <div
                        class="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-800">
                        <div class="min-w-[1200px]">
                            ...
                            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                                @for($i = 0; $i < 3; $i++) <div class="px-6 py-4 animate-pulse">
            ...
            <div x-show="!collapsed" wire:loading.remove.delay x-transition:enter="transition ease-out duration-500"
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button @click="collapsed = !collapsed"
                        ...
                        <x-heroicon-o-chevron-down class="w-4 h-4 text-gray-500 dark:text-gray-400 transition-transform"
                            x-bind:class="{ 'rotate-180': collapsed }" />
                    </button>
                </div>
            </div>
