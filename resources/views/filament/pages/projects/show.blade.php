                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-3">
                            ...
                            <button x-on:click="$dispatch('open-modal', { id: 'all-documents-modal' })"
                                ...
                                <span
                                    class="group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">Legal</span>
                            </button>
                ...
                <div class="flex flex-col sm:flex-row gap-6 sm:gap-8">
                    ...
                    <div class="flex-1">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-2">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Project Progress</h2>
