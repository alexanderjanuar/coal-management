<x-filament::page>
    ...
    <div x-data="{ 
        ...
        <div wire:loading wire:target="$refresh"
            ...
            <div class="flex items-center gap-3 rounded-xl bg-white px-6 py-4 shadow-2xl dark:bg-gray-900">
        ...
        <div class="page-transition mb-4">
            <div
                ...
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            ...
                            <x-filament::icon icon="heroicon-o-building-office-2" class="h-5 w-5 text-white" />
                        </div>
                        <div>
            ...
            <div
                ...
                <div class="p-3">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <a href="{{ route('filament.admin.laporan-pajak.resources.tax-reports.view', $monthReport) }}"
                            ...
                            <div class="absolute left-1 top-1 z-10">
                                ...
                                <div class="flex h-4 w-4 items-center justify-center rounded-full bg-green-500 shadow-sm"
                                    title="Sudah Lapor">
                                    <x-filament::icon icon="heroicon-m-check" class="h-2.5 w-2.5 text-white" />
                                </div>
                                @else
                                <div class="flex h-4 w-4 items-center justify-center rounded-full bg-orange-500 shadow-sm"
                                    title="Belum Lapor">
                            ...
                            <div class="absolute right-1 top-1 z-10">
                                <span class="flex h-2 w-2">
                                    ...
                                    <span
                                        class="relative inline-flex h-2 w-2 rounded-full {{ $isCurrent ? 'bg-blue-500' : 'bg-green-500' }}"></span>
                                </span>
                            </div>
                            @endif

                            <span
                                class="relative z-10 text-[10px] font-semibold uppercase tracking-wider {{ $isCurrent ? 'text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-400' }}">
                            ...
                            {{-- Counts on hover --}}
                            <div
                                class="absolute left-1/2 top-full z-50 mt-2 hidden min-w-[140px] -translate-x-1/2 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white shadow-xl group-hover:block dark:bg-gray-800">
                        ...
                        @else
                        <div
                            class="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 px-2 py-3 opacity-50 dark:border-gray-800 dark:bg-gray-900/20">
                            <span
                                class="text-[10px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-600">
                                {{ substr($monthName, 0, 3) }}
                            </span>
                    ...
                    {{-- Legend --}}
                    <div class="mt-3 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs">
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="text-gray-600 dark:text-gray-400">Belum Ada Data</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <button @click="activeTab = 'invoices'"
                            ...
                            <div :class="activeTab === 'invoices' ? 'bg-blue-600 shadow-lg shadow-blue-500/50' : 'bg-gray-100 group-hover:bg-blue-100 dark:bg-gray-700'"
                                class="flex h-12 w-12 items-center justify-center rounded-xl transition-all duration-200">
                                <x-filament::icon icon="heroicon-o-document-text"
        ...
        {{-- Tab Content - Full Width with Minimal Padding --}}
        <div>
            {{-- PPN Content --}}
