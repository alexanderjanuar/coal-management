...
<x-filament-panels::page>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Left Column: User Information and Statistics -->
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3 text-sm divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <div class="flex justify-between items-center py-2">
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-white">{{ $user->created_at ? $user->created_at->format('M d, Y') : 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2">
                            <div class="flex items-center text-gray-500 dark:text-gray-400 gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-white">{{ $client->name ?? 'Not Assigned' }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2">
                            <div class="flex items-center text-gray-500 dark:text-gray-400 gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
                        ...
                        <div class="flex justify-between items-center py-2">
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-white">{{ $activities->isNotEmpty() ? $activities->first()->created_at->diffForHumans() : 'No activity' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div
                            class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                        ...
                        <div
                            class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-lg p-4 border border-green-200 dark:border-green-800">
                            <div class="flex items-center justify-between">
                        ...
                        <div
                            class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                            <div class="flex items-center justify-between">
                        ...
                        <div
                            class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/30 rounded-lg p-4 border border-red-200 dark:border-red-800">
                            <div class="flex items-center justify-between">
                    ...
                    <div class="mt-6">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                {{ $stats['totalProjects'] > 0 ? round(($stats['completedProjects'] / $stats['totalProjects']) * 100) : 0 }}%
                            </span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                            <div class="bg-primary-600 h-2.5 rounded-full"
                                style="width: {{ $stats['totalProjects'] > 0 ? round(($stats['completedProjects'] / $stats['totalProjects']) * 100) : 0 }}%">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            ...
                            @foreach ($projectTypes as $type => $projects)
                                ...
                                @endphp
                                <div
                                    class="bg-white dark:bg-gray-700 p-2 rounded-lg border border-gray-100 dark:border-gray-600 text-center">
                                    <div class="text-xs text-gray-500 dark:text-gray-400">{{ ucfirst($type) }}</div>
                        ...
                        <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 mb-4">
                            ...
                            <div>
                                <select id="project-status-filter"
                                    class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                                ...
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 project-row"
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div
                                                                class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-md 
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            @if ($userProject->project && $userProject->project->client && $userProject->project->client->logo)
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        <span
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="-ml-0.5 mr-1.5 h-3 w-3" viewBox="0 0 20 20"
                                                                fill="currentColor">
                                                                {!! $priorityIcon !!}
                                                            </svg>
                                                            {{ ucfirst($userProject->project->priority) }}
                                                        </span>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        @php
                                                            $statusMap = [
                                                                'draft' => [
                                                                    'class' =>
                                                                        'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
                                                                    'icon' => '<path d="M9 4.5v15m6-6.51V4.5" />',
                                                                ],
                                                                'analysis' => [
                                                                    'class' =>
                                                            ...
                                                            $status = $statusMap[$userProject->project->status] ?? [
                                                                'class' =>
                                                                    'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
                                                                'icon' => '',
                                                            ];
                                                            ...
                                                            $statusLabel = ucfirst(
                                                                str_replace('_', ' ', $userProject->project->status),
                                                            );
                                                        @endphp
                                                        <span
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        <div class="flex flex-col items-center">
                                                            ...
                                                            @if ($userProject->project->status !== 'completed' && $userProject->project->status !== 'canceled')
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        @php
                                                            ...
                                                            // Variables for total project document counts
                                                                ...
                                                                if ($userProject->project) {
                                                                    ...
                                                                    if ($projectSteps && $projectSteps->count() > 0) {
                                                                        ...
                                                                        if ($totalRequiredDocuments > 0) {
                                                                            $requiredDocumentIds = $requiredDocuments
                                                                                ->pluck('id')
                                                                                ->toArray();

                                                                            // Get documents submitted by this user with filepath info
                                                                            $userSubmittedDocs = \App\Models\SubmittedDocument::whereIn(
                                                                            ...
                                                                            $totalProjectDocuments = \App\Models\SubmittedDocument::whereIn(
                                                                                'required_document_id',
                                                                                $requiredDocumentIds,
                                                                            )->count();

                                                                            // Calculate percentage for progress bar (based on user submissions)
...
// Format the tooltip text with filenames
                                                            ...
                                                            <div class="flex items-center justify-between mb-1">
                                                                <div
                                                                    ...
                                                                    <span class="cursor-help"
                                                                        ...
                                                                        {{ $totalRequiredDocuments }}
                                                                        <span
                                                                            class="ml-1 text-xs text-gray-500 dark:text-gray-400">({{ $totalProjectDocuments }}
                                                                            total)</span>
                                                                    </span>
                                                                </div>
                                                                <span
                                                                    class="text-xs text-gray-500 dark:text-gray-400">{{ $userPercentage }}%</span>
                                                            </div>
                                                            <div
                                                            ...
                                                            @if (!empty($submittedFileNames))
                                                                <div class="mt-1">
                                                                    <button type="button"
                                                                        ...
                                                                        x-data="{}"
                                                                        x-on:click="$tooltip('{{ implode('\n', $submittedFileNames) }}', { theme: $store.theme })">
                                                                        View files
                                                                    </button>
                                                                </div>
                                                            @endif
                                ...
                                <div class="flex justify-center items-center py-8 text-gray-500 dark:text-gray-400">
                                    <div class="text-center">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No Projects
                                            Assigned</h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">This user doesn't have
                                            any projects assigned yet.</p>
                                    </div>
                                </div>
                            @endif
                        </div>
                                                ...
                                                <tr
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        @if ($userClient->client->email)
                                                            <div
                                                                class="text-sm text-gray-900 dark:text-white flex items-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        @if ($userClient->client->ar_phone_number)
                                                            <div
                                                                class="text-sm text-gray-900 dark:text-white flex items-center mt-1">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="h-4 w-4 mr-1 text-gray-400" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round"
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        @else
                                                            <span
                                                                ...
                                                                <svg class="mr-1.5 h-2 w-2 text-red-400"
                                                                    fill="currentColor" viewBox="0 0 8 8">
                                                                    <circle cx="4" cy="4" r="3" />
                                                                </svg>
                                                                Inactive
                                                    ...
                                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                        <div>
                                                            <p class="text-sm text-gray-800 dark:text-gray-200">
                                                                ...
                                                                @if ($modelName)
                                                                    <span
                                                                        class="font-medium">{{ $modelName }}</span>
                                                                @endif
                                                                @if ($activity->subject_id)
                                                                    <span
                                                                        class="text-gray-500 dark:text-gray-400">#{{ $activity->subject_id }}</span>
                                                                @endif
                                                            </p>
                                                                        ...
                                                                        @foreach ($attributesToShow as $key => $value)
                                                                            @if (is_string($value) || is_numeric($value))
                                                                                <span
                                                                                    ...
                                                                                    <span
                                                                                        class="font-medium">{{ Str::title(str_replace('_', ' ', $key)) }}:</span>
                                                                                    <span
                                                                                        class="ml-1">{{ Str::limit($value, 30) }}</span>
                                                                                </span>
                                                                            @endif
                                                                        @endforeach
                                                                    </p>
                                ...
                                @if ($activities->count() >= 10)
                                    <div class="mt-4 text-center">
                                        <a href="#"
                                            ...
                                            View more activity
                                            <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 h-5 w-5"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
